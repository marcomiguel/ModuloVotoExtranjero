...
;(function($) {
    ...
    $.Zebra_DatePicker = function(element, options) {
            ...
            if (!plugin.settings.always_visible) {
                ...
                if (!update) {
                    ...
                    if (plugin.settings.show_icon) {
                        ...
                        // icon = jQuery('<span class="Zebra_DatePicker_Icon add-on' + ($element.attr('disabled') == 'disabled' ? ' Zebra_DatePicker_Icon_Disabled' : '') + '"><i class="icon-calendar"></i></span>');
                        icon = jQuery('<button type="button" data-toggle="datepicker" class="btn' + ($element.attr('disabled') == 'disabled' ? ' Zebra_DatePicker_Icon_Disabled' : '') + '"><i class="icon-calendar"></i></button>');
        ...
        plugin.check_date = function(values) {

            return check_date(values);

        };


        plugin.format = function(date) {
        ...
        plugin.update = function(values) {
            ...
            // console.log('plugin.original_direction', plugin.original_direction);
