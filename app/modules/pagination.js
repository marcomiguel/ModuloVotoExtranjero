...
.directive('pagination', ['paginationConfig', function(config) {	
  return {
    ...
    link: function(scope, element, attrs, paginationCtrl) {
      ...
      scope.$watch('numPages + currentPage + maxSize + totalRegistros + seleccionMostrar', function() {
        ...
        //pintando los totales
        var totalPrevio = (scope.currentPage*parseInt(scope.seleccionMostrar) > parseInt(scope.totalRegistros))?(scope.totalRegistros):(scope.currentPage*parseInt(scope.seleccionMostrar)),
        totalInicio = (scope.currentPage*parseInt(scope.seleccionMostrar) - parseInt(scope.seleccionMostrar)) + 1;
        
        scope.paginado = {
        	inicio : isNaN(totalInicio)?'':totalInicio,
        	cantidad : isNaN(totalPrevio)?'':totalPrevio,
        	total : scope.totalRegistros
        }        
        //fin pintado de los totales
